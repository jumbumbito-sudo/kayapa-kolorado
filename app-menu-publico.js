/* ==========================================================================
   app-menu-publico.js - Lógica de la Carta Digital para el Público (Sin Calculadora)
...
const menuItems = [
    ...
    },
    {
        ...
        desc: 'Contamos con una selección de cortes Premium: Tomahawk, Ribeye, T-bone, Picaña, Cuadril, Cowboy o Bife de chorizo. Consulte disponibilidad y precios de nuestras existencias del día directamente con el personal.',
        category: 'especiales',
        price: null,
        badges: ['special'],
        isInfoOnly: true,
    ...
    // --- BEBIDAS & POSTRES ---
    {
        id: 'postre-del-dia',
        name: 'Postre del Día',
        desc: 'Una dulce sorpresa preparada en casa con ingredientes frescos de la estación. Consulte al personal la opción disponible para hoy.',
        ...
        card.innerHTML = `
            ...
            <div class="dish-card-footer">
                ...
                ${item.isInfoOnly ? 
                    ...
                    `<button class="btn-card-add" aria-label="Ver detalles"><i data-lucide="eye"></i></button>`
                }
            </div>
        `;
...
function calculateModalPrice() {
    ...
    elements.modalPrice.textContent = `$${totalPrice.toFixed(2)}`;
}
